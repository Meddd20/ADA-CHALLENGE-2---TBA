...
enum GameViewType: CaseIterable {
    case punch, flip, recorder, compass, ballBalancing, cameraExpression, rockPaperScissors, wordle, slotMachine, cubeShaper, speechRecognition, catMeowMimic, anomaly
}
